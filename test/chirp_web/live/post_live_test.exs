defmodule ChirpWeb.PostLiveTest do
  ...
  @create_attrs %{body: "some body", likes_cout: 42, reports_count: 42, username: "some username"}
  @update_attrs %{body: "some updated body", likes_cout: 43, reports_count: 43, username: "some updated username"}
  @invalid_attrs %{body: nil, likes_cout: nil, reports_count: nil, username: nil}
